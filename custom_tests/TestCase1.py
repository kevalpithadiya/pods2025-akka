# Create a user and a wallet with some balance. Then:
# 1. Make first order and check that the price is discounted. Make second order and check the price is not discounted.
